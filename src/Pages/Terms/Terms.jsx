  ...
  return (
    <div className={style.container}>
      ...
      <p className={style.point}>
        ...
        of LINXMARKETIX, located at <span className={style.insideH} onClick={()=>navigate("/")}>www.linxmarketix.com</span> 
      </p>
      <p className={style.point}>
      ...
      <p className={style.point}>
        ...
        use cookies in agreement with the Company Name’s <span className={style.insideH} onClick={()=>navigate("/policy")}>Privacy Policy</span> .
      </p>
      ...
      <h2 className={style.subtitle}>License</h2>
      ...
      <p className={style.sWarn}>You must not:</p>
      ...
      <p className={style.sWarn}>You warrant and represent that:</p>
      ...
      <h2 className={style.subtitle}>Hyperlinking to our Content</h2>
      ...
      <p className={style.point}>
        ...
        e-mail to Company Name. Please include your name, your organization
      ...
      <h2 className={style.subtitle}>iFrames</h2>
      <p className={style.point}>
      ...
      <h2 className={style.subtitle}>Content Liability</h2>
      <p className={style.point}>
      ...
      <h2 className={style.subtitle}>Reservation of Rights</h2>
      <p className={style.point}>
      ...
      <h2 className={style.subtitle}>Removal of links from our website</h2>
      <p className={style.point}>
      ...
      <h2 className={style.subtitle}>Disclaimer</h2>
      <p className={style.sWarn}>
