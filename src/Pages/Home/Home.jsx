      ...
      <div className={style.background}>
        ...
        >
          <div className={`carousel-inner h-100 ${style.inner}`}>
            <div
              className={`carousel-item active h-100 ${style.item}`}
              data-bs-interval="10000"
            >
              <img
                src="https://img.freepik.com/free-photo/experienced-colleagues-standing-office-room-looking-each-other-professional-content-ceo-pretty-businesswomen-discussing-work-project-business-communication-corporation-concept_74855-11683.jpg?size=626&ext=jpg&ga=GA1.1.1594462479.1678118375&semt=ais"
            ...
            <div className="carousel-item h-100" data-bs-interval="10000">
              <img
                src="https://media.istockphoto.com/id/1014086436/photo/3d-rendering-code-on-laptops-screen.jpg?b=1&s=170667a&w=0&k=20&c=zI9Ir1EG12jz3tddXDN4Liwl7AltOaoD_o6BxklSKmA="
            ...
            <div className="carousel-item h-100" data-bs-interval="10000">
              <img
                src="https://img.freepik.com/premium-photo/business-man-shake-hands-with-partnerships-introducing-themselves-first-time-meet_36317-1506.jpg?size=626&ext=jpg&ga=GA1.1.1594462479.1678118375&semt=ais"
                className="d-block w-100"
                alt="..."
              />
            </div>
